...
public class expression
{
    ...
    public void simpleLBPhistogram(Mat imageGray, Mat histogram, int hdivs, int vdivs, boolean uniform) {        
        nativeSimpleLBPhistogram(mNativeObj, imageGray.getNativeObjAddr(), histogram.getNativeObjAddr(), hdivs, vdivs, uniform);
    }

    public void ARLBP(Mat imageGray, Mat histogram, int hdivs, int vdivs) {        
        nativeARLBP(mNativeObj, imageGray.getNativeObjAddr(), histogram.getNativeObjAddr(), hdivs, vdivs);
    }
    ...
    private static native void nativeSimpleLBPhistogram(long thiz, long face, long hist, int hdiv, int vdiv, boolean uniform);
    private static native void nativeSetFilterSize(long thiz, int h, int w);
    private static native void nativeARLBP(long thiz, long inputImage, long histogram, int hdivs, int vdivs);
