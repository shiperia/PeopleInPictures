...
JNIEXPORT void JNICALL Java_com_siperia_peopleinphotos_expression_nativeSimpleLBPhistogram
(JNIEnv * jenv, jclass, jlong thiz, jlong jFace, jlong jHistogram, jint ydivs, jint xdivs, jboolean uniform) {
	try {
		((expression_recognizer*)thiz)->simpleLBPhistogram(*((Mat*)jFace), *((Mat*)jHistogram), ydivs, xdivs, uniform);
	}
	catcher("nativeSimpleLBPhistogram")
}

JNIEXPORT void JNICALL Java_com_siperia_peopleinphotos_expression_nativeARLBP
(JNIEnv * jenv, jclass, jlong thiz, jlong jFaceMat, jlong jHistogram, jint ydivs, jint xdivs)
{
	try {
		((expression_recognizer*)thiz)->ARLBP(*((Mat*)jFaceMat), *((Mat*)jHistogram), ydivs, xdivs);
	}
	catcher("nativeARLBP")
}
